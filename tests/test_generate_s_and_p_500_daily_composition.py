...
import pytest
import pandas as pd
from s_and_p_500_picker.generate_s_and_p_500_daily_composition import generate_s_and_p_500_daily_composition
...
MOCK_CONFIG = {
    ...
    "paths": {
        "daily_composition": "fake_path.csv"
    }
}

MOCK_CURRENT_COMPANIES = pd.DataFrame({
    "Ticker": ["AAPL", "TSLA"],
    "Company Name": ["Apple", "Tesla"]
})
...
def test_generate_s_and_p_500_daily_composition(mocker):
    ...
    """
    mocker.patch('s_and_p_500_picker.generate_s_and_p_500_daily_composition.config', MOCK_CONFIG)
