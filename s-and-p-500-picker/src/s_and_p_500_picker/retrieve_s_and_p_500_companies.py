...
def retrieve_s_and_p_500_companies() -> tuple[pd.DataFrame, pd.DataFrame]:
    ...
    headers = {
        "User-Agent": "S&P 500 Picker/1.0 (kodiz2005@gmail.com)"
    }
...
if __name__ == "__main__":
    ...
    print(f"S&P 500 Companies from {config['date_range']['start_date']} to {config['date_range']['end_date']}:")
    print(companies.head())
    print(f"Historical Changes from {config['date_range']['start_date']} to {config['date_range']['end_date']}:")
    print(changes.head())