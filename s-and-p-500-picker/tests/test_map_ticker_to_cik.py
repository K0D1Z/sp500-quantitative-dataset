...
MOCK_CURRENT_COMPANIES = pd.DataFrame({
    ...
    "CIK": ["320193", "789019"] # Celowo bez zer na początku, żeby sprawdzić zfill(10)
})
...
def test_map_ticker_to_cik_missing_warning(mocker, capsys):
    ...
    assert "WARNING: The following historical tickers are still missing CIKs" in captured.out
